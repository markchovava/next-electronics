    ...
    <div>
        ...
        <section className='w-[100%]'>
            <div className='mx-auto w-[90%] border-b border-slate-200'>
                <ul className='flex items-center justify-start gap-2 px-3 py-2'>
                    ...
                    <li><FaAngleRight /></li>
                    <li><Link href='/admin/brand/add'>Add Brand</Link></li>
                </ul>
            </div>
        </section>
        ...
        <section className='w-[100%]'>
          <div className='mx-auto w-[90%] flex items-center justify-end'>
            <Link href='/admin/brand' className='text-white rounded-lg px-6 py-3 transition-all duration-200 ease-in-out bg-gradient-to-br from-orange-500 to-pink-500 hover:gradient-to-br hover:from-pink-500 hover:to-orange-600'>
               Brand List
            </Link>
          </div>
        </section>
