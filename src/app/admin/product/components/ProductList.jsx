      ...
      <section className='w-[100%]'>
        <div className='w-[90%] border-x border-b border-slate-300 mx-auto flex items-center justify-start '>
          ...
          <div className='w-[15%] px-3 py-2 flex items-center justify-start gap-4'>
            <Link href='/admin/product/1'> <FaEye className='hover:text-blue-500 duration-150 hover:scale-110 transition-all ease-in'/> </Link>
            <Link href='/admin/product/edit/1'> <MdEdit className='hover:text-green-500 duration-150 hover:scale-110 transition-all ease-in' /> </Link>  
            <button> 
                <MdDeleteForever 
